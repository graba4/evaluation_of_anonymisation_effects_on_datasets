...
class ModelInspector(object):
    ...
    def compare_histograms(self, attribute, plot_id):
        ...
        # ignore non-categorical string attributes
            ...
            fig.autofmt_xdate()
            plt.savefig("plots/census_comparison" + str(plot_id) + ".jpg")
    ...
    def mutual_information_heatmap(self, attributes: List = None):
        ...
        plt.savefig("plots/census_mutual_information_heatmap.jpg")
